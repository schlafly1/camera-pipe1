...
bool NvDsInferParseCustomDDETRTAO (std::vector<NvDsInferLayerInfo> const &outputLayersInfo,
    ...
    for (unsigned int idx = 0; idx < numDetections; idx += 1) {
        ...
        // Skip forklift and pallet, refer detector_labels.txt for the class ids
        // if (res.classId != 0 && res.classId != 1 && res.classId != 2 && res.classId != 3 && res.classId != 4 && res.classId != 5) {
        //     continue;
        // }
